...
public class ConnectarDBNotaFiscal {
	...
	public ArrayList<NotaFiscal> listar() throws SQLException, ClassNotFoundException, PedidoNaoEncontradoException, IOException {
	...
	private Pedido getPedido(int codigo)
			throws SQLException, PedidoNaoEncontradoException, ClassNotFoundException, IOException {
	...
	public ArrayList<NotaFiscal> procurar(Map<String, Object> valores) throws SQLException, ClassNotFoundException, PedidoNaoEncontradoException, IOException {
