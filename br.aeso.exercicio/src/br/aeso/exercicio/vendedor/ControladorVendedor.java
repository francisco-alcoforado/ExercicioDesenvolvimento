...
public class ControladorVendedor {
	...
	public void cadastrar(Vendedor Vendedor) throws IllegalArgumentException, VendedorJaCadastradoException, IOException, VendedorNaoEncontradoException{
		if(Vendedor == null){
	...
	public void atualizar(Vendedor Vendedor) throws IOException, VendedorNaoEncontradoException{
		if(this.procurar(Vendedor.getCodigo()) == null){
	...
	public Vendedor procurar(int codigo) throws VendedorNaoEncontradoException{
