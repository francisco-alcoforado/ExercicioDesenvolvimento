...
public class ConnectarDBVenda {
	...
	public ArrayList<Venda> listar() throws SQLException, ClassNotFoundException, ProdutoNaoEncontradoException,
			IOException, PedidoNaoEncontradoException {
	...
	private Pedido getPedido(int codigo)
			throws SQLException, ClassNotFoundException, IOException, PedidoNaoEncontradoException {
	...
	public ArrayList<Venda> procurar(Map<String, Object> valores) throws SQLException, ClassNotFoundException, ProdutoNaoEncontradoException, IOException, PedidoNaoEncontradoException {
